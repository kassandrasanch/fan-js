...
// gsap.utils.toArray(".section-banner ").forEach((banner) => {
//   ScrollTrigger.create({
//     trigger: banner,
//     start: "top top", // when this banner’s top reaches the top of the viewport
//     endTrigger: banner,
//     end: "bottom top", // keep pinning until its bottom reaches the top of the viewport
//     pin: true,
//     pinSpacing: true, // reserve its space so the page doesn’t jump
...
// 2) then add ONE global “proximity snap” trigger:
// const snapEls = gsap.utils.toArray(".section-banner, .n_section-header");
// const snapPoints = snapEls.map(el =>
//   ScrollTrigger.positionInViewport(el, "top top")
// );
...
//   end: "bottom bottom",
//   snap: {
//     snapTo: snapPoints, // array of Y-positions to snap to
//     duration: 0.15, // how fast to snap
//     ease: "power1.out",
//     proximity: 20 // only snap if you’re within 20px of one
//   },
//   //markers: true
// });
