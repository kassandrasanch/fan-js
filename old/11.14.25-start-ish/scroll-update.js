...
//         const labelProgress = slides.map((_, i) => {
//             const name = `slide-${i}`;
//             const t = tl.labels[name];
//             return typeof t === "number" && tl.duration() ? t / tl.duration() : 0;
//         });
//         return { tl, slides, wrapper, labelProgress, ranges: [] };
//     });
...
//     sectionAnchors.forEach((section, i) => setToggleSectionInfo(section, i));
...
function wireNav() {
    ...
    //         const targetElem = document.querySelector(targetID);
    //         if (!targetElem) return;
    //         console.log("click nav to", targetID);
    //         gsap.to("body", {
    //             opacity: 0,
    //             duration: 0.1,
    //             onComplete() {
