...
function buildSliders() {
    ...
    const isSkip = (el) =>
        el.matches(".n_text-reveal-section, .n_scroll-accordion, .section--icon") ||
...
initScrollSliders();
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// // try 8 11.3.25 works ish but buggy. doesnt end right either
// // issues
// // nav zindex issue
// // scrollbar not showing full height issue
// // text sections
...
// initScrollSliders();
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// // try 7 10.31.25 works ish but buggy. doesnt end right either
// // issues
// // nav zindex issue
// // scrollbar not showing full height issue
// // text sections
...
// (function buildSliders() {
//   const roots = document.querySelectorAll(".main-wrapper, .main-wrapper > section");

//   const isSkip = el => el.matches(".n_text-reveal-section");
//   const isSlideable = el =>
//     el.matches(".section-banner, .n_section-header, .section-split, .n_scrolling-slider");
...
//     const flush = () => {
//       if (run.length <= 1) { run = []; return; }  // only wrap if 2+ panels
//       const wrap = document.createElement("div");
//       wrap.className = "single-scroll-section";
//       run[0].parentNode.insertBefore(wrap, run[0]);
//       run.forEach(n => wrap.appendChild(n));
...
//       const el = kids[i];
//       if (isSkip(el)) { flush(); continue; }
//       if (isSlideable(el)) run.push(el);
//       else flush();
//     }
//     flush();
//   });
...
// ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// // try 6 10.31.25 works ish but buggy. doesnt end right either
// // issues
// // nav zindex issue
// // scrollbar not showing full height issue
// // text sections
...
//     if (!intentObserver) return "observer not defined";
//     return intentObserver.isEnabled ? "enabled" : "disabled";
// };
...
//         console.log("reached end/beginning, return to normal scroll");
//         let target = index;
//         gsap.to(target, {
//             // xPercent: isScrollingDown ? -100 : 0,
//             duration: 0.0,
//             onStart: () => {
//                 console.log("onStart return to normal scroll");
//             },
//             onComplete: () => {
//                 animating = false;
...
//         duration: 2,
//         onStart: () => {
//             console.log("onstart gotoPanel anim");
//         },
//         onComplete: () => {
//             animating = false;
...
// let nextSection = document.querySelector('.observer-section').parentElement.nextElementSibling;
...
//     //     // const h = section.offsetHeight; // or a custom calc
//     //     console.log(document.querySelector(".observer-section").offsetHeight);
...
// });
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// try 5 10.31.25 works when scrolling down but not up
// issues
// nav zindex issue
// scrollbar not showing full height issue
// text sections
...
// const getObserverState = () => {
//     if(!observer) return 'observer not defined';
//     return observer.isEnabled ? 'enabled' : 'disabled';
// }
...
//     console.log(`observer.isEnabled`)
//     console.log(observer.isEnabled)
//     if(animating){
...
//     const tl = gsap.timeline({
//         defaults: { duration: 2.0, ease: "power1.inOut" },
//         onComplete: () => {
