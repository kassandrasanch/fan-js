// This file was generated by Slater.app - p1-update.js
...
const lenis = new Lenis({
  ...
  smooth: true,
  wheelMultiplier: 0.7,
  touchMultiplier: 2, //just added 6.7
});
...
function revealText(wrapper) {
  ...
  blocks.forEach((block, i) => {
    ...
    if (block.dataset.animateSpecial === 'like-this') {
      ...
      const typographyFansSvg = wrapper.querySelector(
        '.special__typography-fans .typography-fans-svg')
      console.log(extra)
      gsap.set(extra, {
        opacity: 0,
        zIndex: -4,
      ...
      specialTl.to(typographyFansSvg, {
